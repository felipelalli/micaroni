 ...
 * please have a look at {@link br.eti.fml.wonderfulstates.changing.MutableState}.
 * </p>
 *
 * <p>
 ...
 */
public abstract class State<T, U extends Universe<T>> {
    /**
     * Means that this state is not ready to be read yet, but could
     * be transformed soon into a valid, fuzzy or broken value.
     *
     * @return true if this State can't be reachable.
     */
    public abstract boolean isUnreachableYet();

    /**
     * By default any read-function needs to wait the value
     * become {@link #isUnreachableYet() reacheable}. The methods
     ...
     * very accurate and it means the maximum time in millis that you'll have
     * to wait to retrieve some value.
     *
     * @return default timeout in millis
     */
    public abstract long getDefaultTimeout();

    /**
     * Indicates that it is an invalid state and all functions to get value
