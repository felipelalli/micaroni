/**
 * $RCSfile: MiniAplicacao.h,v $
 * $Date: 2005/03/04 00:38:20 $
 * $Revision: 1.7 $
 * $Author: cvsroot $
 * Tag: $Name:  $
...
#if !defined(AFX_MINIAPLICACAO_H__4D45CD66_2240_4D69_93B1_5B745F09E71F__INCLUDED_)
#define AFX_MINIAPLICACAO_H__4D45CD66_2240_4D69_93B1_5B745F09E71F__INCLUDED_
 ...
 namespace dinamicas {
  namespace sinfonia {
   namespace miniaplicacao {
	 ...
	 */
	class MiniAplicacao: public Executavel, public Objeto {
		public:
			MiniAplicacao();
			virtual ~MiniAplicacao();
