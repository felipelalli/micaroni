...
#ifndef AGES_SPECIAL_UPGRADE_SBS_SORTEIO_SW_H
#define AGES_SPECIAL_UPGRADE_SBS_SORTEIO_SW_H
    ...
    namespace specialUpgrade {
	  namespace logica {
		...
		class SorteioBolas : public Sorteio {
			...
			public:
				SorteioBolas::SorteioBolas(string nomeProcesso);
