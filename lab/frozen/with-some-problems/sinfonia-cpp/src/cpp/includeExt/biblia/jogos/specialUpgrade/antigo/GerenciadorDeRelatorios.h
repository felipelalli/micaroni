...
#include "biblia/jogos/specialUpgrade/antigo/ManipuladorDeTabela.h"
...
#ifndef AGES_SPECIAL_UPGRADE_SBS_GERENCIADOR_DE_RELATORIO_H_SW
#define AGES_SPECIAL_UPGRADE_SBS_GERENCIADOR_DE_RELATORIO_H_SW
