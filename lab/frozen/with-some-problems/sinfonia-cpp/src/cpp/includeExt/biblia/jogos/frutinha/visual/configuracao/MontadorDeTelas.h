...
*/
			...
			class BotaoMudaAcumuladoMinimo: public BotaoComThis {
				public:
					BotaoMudaAcumuladoMinimo::BotaoMudaAcumuladoMinimo() {}
					virtual BotaoMudaAcumuladoMinimo::~BotaoMudaAcumuladoMinimo() {}
					virtual Executavel& BotaoMudaAcumuladoMinimo::executa();
			};
			...
			class MontadorDeTelas: public Carregador {
				...
				public:
					...
					virtual EstadosTropical& MontadorDeTelas::jogo();
					virtual MontadorDeTelas& MontadorDeTelas::defineJogo(
