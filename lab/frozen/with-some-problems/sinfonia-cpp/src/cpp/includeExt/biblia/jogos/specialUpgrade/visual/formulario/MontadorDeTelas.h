...
#if !defined(AGES_SPECIAL_UPGRADE_SBS_AFX_MONTADORDETELAS_H__85D5DA5B_7114_4F2A_BD66_7D2BB019A67B__INCLUDED_)
#define AGES_SPECIAL_UPGRADE_SBS_AFX_MONTADORDETELAS_H__85D5DA5B_7114_4F2A_BD66_7D2BB019A67B__INCLUDED_
...
#include "biblia/jogos/specialUpgrade/dados/EnviadorDeDadosPelaRede.h"
#include "biblia/jogos/specialUpgrade/dados/ZeradorDeDados.h"
	  ...
	  namespace visual {
		namespace formulario {
			...
			class ExecutandoBotao: public BotaoComThis {
				private:
					string ExecutandoBotao::oq;

				protected:
					virtual ExecutandoBotao& ExecutandoBotao::aperte();

				public:
					ExecutandoBotao::ExecutandoBotao(string id);
			...
			class BotaoViraPaginaHistorico: public BotaoComThis {
				...
				public:
					BotaoViraPaginaHistorico
							::BotaoViraPaginaHistorico(string o,
								bool praTras = false)
...
*/
			...
			class BotaoTocaSom: public BotaoComThis {
				protected:
					string BotaoTocaSom::nome;

				public:
					BotaoTocaSom::BotaoTocaSom(string nome);
