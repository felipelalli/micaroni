...
#if !defined(SBS_AFX_ARENDERIZADORGRAFICODOUBLE_H__691CF28A_3E2F_40C1_8471_B83061FB6192__INCLUDED_)
#define SBS_AFX_ARENDERIZADORGRAFICODOUBLE_H__691CF28A_3E2F_40C1_8471_B83061FB6192__INCLUDED_
	  ...
	  namespace visual {
		...
		class RenderizadorGraficoDouble: public Renderizador {
			...
			protected:
				...
				// Novas bolas extras da barra.
/*
				virtual RenderizadorGraficoDouble&
						novaBolaExtra(bool exibir);

				virtual RenderizadorGraficoDouble&
						novaBolaExtraAbre(int qual, int numeroBola);

				virtual RenderizadorGraficoDouble&
						novaBolaExtraSeleciona(int qual);
*/
				virtual RenderizadorGraficoDouble&
						RenderizadorGraficoDouble
							::atualizaBolas();
