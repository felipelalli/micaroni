...
#ifndef AGES_SPECIAL_UPGRADE_SBS_TABELA_H_SW
#define AGES_SPECIAL_UPGRADE_SBS_TABELA_H_SW
	...
	namespace jogos {
		namespace specialUpgrade {
			namespace antigo {
				...
				class Linha{
					private:
						biblia::armazenamento::volatil::Lista* pCelulas;
						int pAlturaLinha;
					public:
				...
				class Tabela: public ComponenteDeUmRelatorio{
					private:
						biblia::armazenamento::volatil::Lista* pLinhas;
						int pQuantasColunas;
						int pCor;
						int pTransparencia;
