...
#ifndef AGES_SPECIAL_UPGRADE_SBS_DCONFIGURACAO_SW_H
#define AGES_SPECIAL_UPGRADE_SBS_DCONFIGURACAO_SW_H
...
#define PREMIO_BINGO_CFG        "->specialUpgrade"
...
#define PROBABILIDADE_BOLA_EXTRA_BINGO_CFG "->bolaExtra->specialUpgrade"
