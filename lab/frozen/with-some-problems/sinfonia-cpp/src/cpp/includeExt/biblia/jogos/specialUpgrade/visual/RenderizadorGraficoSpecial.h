...
#if !defined(AGES_SPECIAL_UPGRADE_SBS_AFX_RENDERIZADORGRAFICOspecial_H__691CF28A_3E2F_40C1_8471_B83061FB6192__INCLUDED_)
#define AGES_SPECIAL_UPGRADE_SBS_AFX_RENDERIZADORGRAFICOspecial_H__691CF28A_3E2F_40C1_8471_B83061FB6192__INCLUDED_
...
#include "biblia/jogos/specialUpgrade/visual/BolasAndando.h"
#include "biblia/jogos/specialUpgrade/visual/FogosDeArtificio.h"
	  ...
	  namespace visual {
		...
		class RenderizadorGraficoSpecial: public Renderizador {
			private:
				...
				// Carregamento:
				const ConclusivoTemporizado* RenderizadorGraficoSpecial
						::pCarregamento;
				...
				deque<string> RenderizadorGraficoSpecial::fluah;

				// animações do "consome" (marcação de prêmio)
				deque<string> RenderizadorGraficoSpecial::consome;

				// falta-uns da cartelinha
				deque<string> RenderizadorGraficoSpecial::faltaUnsDaCartelinha;
