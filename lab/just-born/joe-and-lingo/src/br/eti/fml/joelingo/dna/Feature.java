...
public class Feature extends JsonCapable<Feature> {
    ...
    public Feature setValue(BigDecimal value) {
        this.value = value.min(new BigDecimal(1.0)).max(new BigDecimal(0.0));
        return this;
    }

    public Feature setValue(double value) {
        this.value = new BigDecimal(String.valueOf(value)).min(new BigDecimal(1.0)).max(new BigDecimal(0.0));
        return this;
    }
}
