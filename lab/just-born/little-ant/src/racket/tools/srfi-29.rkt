...
; Source extracted from https://srfi.schemers.org/srfi-29/srfi-29.html

(require srfi/6) ; Basic String Ports
(require srfi/23) ; Error reporting mechanism
(require srfi/28) ; Basic Format Strings
